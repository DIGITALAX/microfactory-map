    ...
    <div className='bg-black min-h-screen flex flex-col items-center'>
      ...
      <section className="my-40 md:mt-80 md:mb-48 flex flex-col md:flex-row pl-8 md:pl-24 lg:pl-36 xl:pl-42 pr-8 md:pr-0">
        ...
        <div className="px-2 md:px-10 w-full md:w-8/12">
          <h1 className="text-xl font-coop relative top-14 left-10 text-white mt-10 md:mt-0 md:text-5xl lg:text-60px text-left">
          RENEWABLE <br />
          WEB3 <br />
          CO-OPS <br />
          </h1>
          <div className="mt-10 font-npress relative top-8 left-12 text-white text-lg md:text-xl lg:text-3xl text-left md:text-left">
      ...
      <section className='text-center mt-16 text-white w-full py-40 text-3xl md:text-4xl lg:text-5xl'>
        in the self sovereign verse <br />
        you are free to build <br />
        your own name & game... <br />
      </section>

      <img className='mt-0 md:mt-40 px-0 md:px-8' src='/assets/images/renewables.png' />
      <img className='w-2/6 md:w-3/12 my-48 px-8 object-contain' src='/assets/images/renew.png' />

      <section id="renewables"  className="flex flex-row w-full justify-center mt-20 md:mt-80 flex-wrap">
        <img
          className="w-1/3 md:w-60 px-1 mx-2 object-contain"
          src="/assets/images/renew1.png"
        />
        <img
          className="w-1/3 md:w-48 mx-4 px-1 object-contain"
      ...
      >
        ...
        <div className="flex flex-col font-shadow md:flex-row items-center justify-between my-24 flex-wrap px-5 md:px-2 ">
          <div className="hashtag m-4 text-2xl md:text-4xl">#howtonode</div>
          <div className="hashtag m-4 text-2xl md:text-4xl">#freetobuild</div>
          <div className="hashtag m-4 text-2xl md:text-4xl">#cc0streetwear</div>
          <div className="hashtag m-4 text-2xl md:text-4xl">#microfactory</div>
          <div className="hashtag m-4 text-2xl md:text-4xl">#seizethememes</div>
        </div>
      </section>
      ...
      Each instructable collected, shared and recycled puts another pixel brick on the build map for a hyper-local web3 microfactory, virtually, and possibly IRL, near you.
        ...
        <div className="mt-8 text-center">
          <button
            className="text-sm px-6 font-npress text-black p-3 md:text-sm lg:text-3xl bg-button rounded-full"
            onClick={setStyleClicked}
          >
            Mint Live Soon
          </button>
          <p className={`w-fit relative flex ml-5 leading-8 font-spacebold  ${!styleState && 'hidden'}`} >
          <a href="https://port15.digifizzy.xyz/magazines/15/" target="_blank" rel="noreferrer"  className='font-opress -left-24 w-72 m-4 absolute text-2xl text-white'>Read DIGIFIZZY while you wait.</a>
          </p>
        </div>
      </section>

      <section className="my-20 md:my-80 flex flex-col md:flex-row pl-8 md:pl-24 lg:pl-36 xl:pl-42 pr-8 md:pr-0">
        <div className="w-full relative -top-10 md:w-4/12">
          <img src="/assets/images/feedkeys.png" />
        </div>
        <div className="px-2 md:px-20 w-full md:w-8/12">
          <h1 className="text-xl text-white mt-10 md:mt-0 md:text-3xl lg:text-60px text-center ">
            HOW WELL YOU CARE <br />
            FOR YOUR COMPANIONS <br />
            SHOWS IN THE LIL’ DETAILS <br />
            TOO RARE TO MISS
          </h1>
          <div className="mt-10 font-thin text-white text-lg md:text-xl lg:text-3xl text-center md:text-center">
      ...
      <section className="mt-0 mb-20 md:mt-20 md:mb-80 flex flex-col md:flex-row px-10 md:px-12 lg:px-24 xl:px-42">
        ...
        <div className="mx-0 font-thin md:mx-4 mt-20 md:mt-0 px-10 border py-10  w-full text-white md:w-1/2">
          <h1 className="text-2xl md:text-3xl lg:text-4xl text-center">
